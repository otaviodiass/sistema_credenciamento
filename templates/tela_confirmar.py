from flet import *
from database.query.credenciamento import buscar_cliente_nome

class TelaConfirmar(Column):
    def __init__(self, page: Page):
        ...
        self.botao_buscar = ElevatedButton(text="Buscar")
    ...
    def cliente_selecionado(self, event):
        ...
        self.botao_confirmar_presenca = ElevatedButton(text="Confirmar Presença")

        self.botao_imprimir = ElevatedButton(text="Imprimir")

        self.botao_editar = ElevatedButton(text="Editar")
        ...
        self.linha_botoes = Row(controls=[self.botao_confirmar_presenca, self.botao_imprimir, self.botao_editar], alignment=MainAxisAlignment.CENTER)
